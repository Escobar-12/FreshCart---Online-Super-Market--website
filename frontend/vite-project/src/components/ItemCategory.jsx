...
const ItemCategory = ({Category}) => {
    return (
        <Link to={`/products?category=${Category.path}`} className={`group rounded-lg flex flex-col justify-center items-center cursor-pointer py-5 px-3 `} style={{ backgroundColor: Category.bgColor }}>
